...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { author: @libro.author, estado: @libro.estado, fecha_devoulto: @libro.fecha_devoulto, fecha_prestamo: @libro.fecha_prestamo, title: @libro.title } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { author: @libro.author, estado: @libro.estado, fecha_devoulto: @libro.fecha_devoulto, fecha_prestamo: @libro.fecha_prestamo, title: @libro.title } }
